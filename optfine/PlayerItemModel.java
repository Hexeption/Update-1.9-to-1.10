...
public class PlayerItemModel
{
    ...
    public PlayerItemModel(Dimension p_i55_1_, boolean p_i55_2_, PlayerItemRenderer[] p_i55_3_)
    {
        this.textureSize = p_i55_1_;
        this.usePlayerTexture = p_i55_2_;
        this.modelRenderers = p_i55_3_;
    }

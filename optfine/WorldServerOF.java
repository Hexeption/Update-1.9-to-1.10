...
public class WorldServerOF extends WorldServer
{
    ...
    public WorldServerOF(MinecraftServer p_i74_1_, ISaveHandler p_i74_2_, WorldInfo p_i74_3_, int p_i74_4_, Profiler p_i74_5_)
    {
        super(p_i74_1_, p_i74_2_, p_i74_3_, p_i74_4_, p_i74_5_);
        this.mcServer = p_i74_1_;
    }

...
public class ReflectorMethod
{
    ...
    public ReflectorMethod(ReflectorClass p_i67_1_, String p_i67_2_)
    {
        this(p_i67_1_, p_i67_2_, (Class[])null, false);
    }

    public ReflectorMethod(ReflectorClass p_i68_1_, String p_i68_2_, Class[] p_i68_3_)
    {
        this(p_i68_1_, p_i68_2_, p_i68_3_, false);
    }

    public ReflectorMethod(ReflectorClass p_i69_1_, String p_i69_2_, Class[] p_i69_3_, boolean p_i69_4_)
    {
        ...
        this.targetMethodName = p_i69_2_;
        this.targetMethodParameterTypes = p_i69_3_;

...
public class BlockPosM extends BlockPos
{
    ...
    public BlockPosM(int p_i10_1_, int p_i10_2_, int p_i10_3_)
    {
        this(p_i10_1_, p_i10_2_, p_i10_3_, 0);
    }

    public BlockPosM(double p_i11_1_, double p_i11_3_, double p_i11_5_)
    {
        this(MathHelper.floor_double(p_i11_1_), MathHelper.floor_double(p_i11_3_), MathHelper.floor_double(p_i11_5_));
    }

    public BlockPosM(int p_i12_1_, int p_i12_2_, int p_i12_3_, int p_i12_4_)
    {
        super(0, 0, 0);
        this.mx = p_i12_1_;
        this.my = p_i12_2_;

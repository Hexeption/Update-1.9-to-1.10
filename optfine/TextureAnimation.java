...
public class TextureAnimation
{
    ...
    public TextureAnimation(String p_i71_1_, byte[] p_i71_2_, String p_i71_3_, ResourceLocation p_i71_4_, int p_i71_5_, int p_i71_6_, int p_i71_7_, int p_i71_8_, Properties p_i71_9_, int p_i71_10_)
    {
        this.srcTex = p_i71_1_;
        this.dstTex = p_i71_3_;
        this.dstTexLoc = p_i71_4_;
        this.dstX = p_i71_5_;
        this.dstY = p_i71_6_;
        this.frameWidth = p_i71_7_;
        this.frameHeight = p_i71_8_;
        int i = p_i71_7_ * p_i71_8_ * 4;

        if (p_i71_2_.length % i != 0)
        {
            Config.warn("Invalid animated texture length: " + p_i71_2_.length + ", frameWidth: " + p_i71_7_ + ", frameHeight: " + p_i71_8_);
        }

        this.srcData = p_i71_2_;
        int j = p_i71_2_.length / i;

        if (p_i71_9_.get("tile.0") != null)
        {
            for (int k = 0; p_i71_9_.get("tile." + k) != null; ++k)
            {
                j = k + 1;
            }
        }

        String s2 = (String)p_i71_9_.get("duration");
        int l = Config.parseInt(s2, p_i71_10_);
        this.frames = new TextureAnimationFrame[j];

        for (int i1 = 0; i1 < this.frames.length; ++i1)
        {
            String s = (String)p_i71_9_.get("tile." + i1);
            int j1 = Config.parseInt(s, i1);
            String s1 = (String)p_i71_9_.get("duration." + i1);

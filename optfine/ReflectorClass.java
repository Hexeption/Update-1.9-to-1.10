...
public class ReflectorClass
{
    ...
    public ReflectorClass(String p_i62_1_)
    {
        this(p_i62_1_, false);
    }

    public ReflectorClass(String p_i63_1_, boolean p_i63_2_)
    {
        this.targetClassName = null;
        this.checked = false;
        this.targetClass = null;
        this.targetClassName = p_i63_1_;
    ...
    public ReflectorClass(Class p_i64_1_)
    {
        this.targetClassName = null;
        this.checked = false;
        this.targetClass = null;
        this.targetClass = p_i64_1_;
        this.targetClassName = p_i64_1_.getName();
        this.checked = true;
    }

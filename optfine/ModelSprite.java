...
public class ModelSprite
{
    ...
    public ModelSprite(ModelRenderer p_i49_1_, int p_i49_2_, int p_i49_3_, float p_i49_4_, float p_i49_5_, float p_i49_6_, int p_i49_7_, int p_i49_8_, int p_i49_9_, float p_i49_10_)
    {
        ...
        this.minU = (float)p_i49_2_ / p_i49_1_.textureWidth;
        this.minV = (float)p_i49_3_ / p_i49_1_.textureHeight;
        this.maxU = (float)(p_i49_2_ + p_i49_7_) / p_i49_1_.textureWidth;
        this.maxV = (float)(p_i49_3_ + p_i49_8_) / p_i49_1_.textureHeight;
    }

...
public class CustomColors
{
    ...
    private static final CustomColors.IColorizer COLORIZER_WATER = new CustomColors.IColorizer()
    {
        ...
        {
            Biome biome = CustomColors.getColorBiome(p_getColor_2_, p_getColor_3_);
            return CustomColors.waterColors != null ? CustomColors.waterColors.getColor(biome, p_getColor_3_) : (Reflector.ForgeBiome_getWaterColorMultiplier.exists() ? Reflector.callInt(biome, Reflector.ForgeBiome_getWaterColorMultiplier, new Object[0]) : CustomColors.getBlockColors().colorMultiplier(p_getColor_1_, p_getColor_2_, p_getColor_3_, 0));
        }
        public boolean isColorConstant()
        {
            return false;

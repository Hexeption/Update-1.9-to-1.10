...
public class PlayerItemRenderer
{
    ...
    public PlayerItemRenderer(int p_i56_1_, float p_i56_2_, ModelRenderer p_i56_3_)
    {
        this.attachTo = p_i56_1_;
        this.scaleFactor = p_i56_2_;
        this.modelRenderer = p_i56_3_;
    }

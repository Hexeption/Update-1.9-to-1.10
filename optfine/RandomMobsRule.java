...
public class RandomMobsRule
{
    ...
    public RandomMobsRule(ResourceLocation p_i60_1_, int[] p_i60_2_, int[] p_i60_3_, Biome[] p_i60_4_, RangeListInt p_i60_5_)
    {
        this.baseResLoc = p_i60_1_;
        this.skins = p_i60_2_;
        this.weights = p_i60_3_;
        this.biomes = p_i60_4_;
        this.heights = p_i60_5_;
    }

...
public class RandomMobsProperties
{
    ...
    public RandomMobsProperties(String p_i58_1_, ResourceLocation[] p_i58_2_)
    {
        ConnectedParser connectedparser = new ConnectedParser("RandomMobs");
        this.name = connectedparser.parseName(p_i58_1_);
        this.basePath = connectedparser.parseBasePath(p_i58_1_);
        this.resourceLocations = p_i58_2_;
    }

    public RandomMobsProperties(Properties p_i59_1_, String p_i59_2_, ResourceLocation p_i59_3_)
    {
        ConnectedParser connectedparser = new ConnectedParser("RandomMobs");
        this.name = connectedparser.parseName(p_i59_2_);
        this.basePath = connectedparser.parseBasePath(p_i59_2_);
        this.rules = this.parseRules(p_i59_1_, p_i59_3_, connectedparser);
    }
